...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # feat_label_dir='/content/drive/MyDrive/TFG/DCASE2024_SELD_dataset/seld_feat_label/',
        ...
        nb_epochs=40,  # Train for maximum epochs
        lr=1e-3,

        #class_weight_mode='soft_sqrt_inv_freq',
        #class_weights=[
        #    0.75, 0.70, 2.00, 1.80, 1.25, 0.85, 1.30,
        ##    2.00, 0.75, 0.95, 1.60, 1.80, 3.00
        #],
        foa_channel_mode='all',
        eta_min=1e-5,
        T_max=40,
        # METRIC
    ...
    if argv == '1':
        ...
        print("BASELINE FOA FULL - 40 epochs\n")
        params['quick_test'] = False
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        params['nb_epochs'] = 40
        ...
        params['foa_channel_mode'] = 'all'

    elif argv == '31':
        print("BASELINE FOA ABLATION - W ONLY\n")
        params['quick_test'] = False
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        params['nb_epochs'] = 40
        params['lr'] = 1e-3
        params['dropout_rate'] = 0.05
        params['foa_channel_mode'] = 'w_only'

    elif argv == '32':
        print("BASELINE FOA ABLATION - WXYZ ONLY / NO IV\n")
        params['quick_test'] = False
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        params['nb_epochs'] = 40
        params['lr'] = 1e-3
        params['dropout_rate'] = 0.05
        params['foa_channel_mode'] = 'wxyz_only'

    elif argv == '33':
        print("BASELINE FOA ABLATION - IV ONLY\n")
        params['quick_test'] = False
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        params['nb_epochs'] = 40
        params['lr'] = 1e-3
        params['dropout_rate'] = 0.05
        params['foa_channel_mode'] = 'iv_only'

    elif argv == '34':
        print("BASELINE FOA ABLATION - XYZ ONLY\n")
        params['quick_test'] = False
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        params['nb_epochs'] = 40
        params['lr'] = 1e-3
        params['dropout_rate'] = 0.05
        params['foa_channel_mode'] = 'xyz_only'
    elif argv == '999':
